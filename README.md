...
- 사이드바 상단에 메디힘·IPPEO 조합 로고 단일 이미지 적용
- 원본 비율을 유지하면서 기존 사이드바 상단 브랜드 구간 안으로 크기 제한
- 버건디 배경에서 조합 로고의 대비를 유지하도록 흰색 락업 적용
- 데스크톱 LNB와 모바일 드로어에서 동일한 비율로 축소
- 로고 원본은 `assets/medihim-ippeo-combination.png`에 저장
